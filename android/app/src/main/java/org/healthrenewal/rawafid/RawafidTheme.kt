...
/**
 * Shared spacing tokens for the native Android product.
 *
 * Keeping these values centralized prevents each screen from inventing its own
 * rhythm and makes future phone/tablet adaptation predictable.
 */
...
/** Semantic accents used alongside Material color roles. */
...
private val LightColors = lightColorScheme(
    ...
    primaryContainer = Color(0xFFC5F3F0),
...
private val DarkColors = darkColorScheme(
    ...
    tertiary = Color(0xFFF6BE4F),
    onTertiary = Color(0xFF443000),
...
private val HighContrastLight = lightColorScheme(
    ...
    secondary = Color(0xFF213F3B),
    onSecondary = Color.White,
    secondaryContainer = Color(0xFFE0FFF8),
    onSecondaryContainer = Color.Black,
    tertiary = Color(0xFF5B3B00),
    onTertiary = Color.White,
...
private val HighContrastDark = darkColorScheme(
    ...
    secondary = Color(0xFFD8FFF6),
    onSecondary = Color.Black,
    secondaryContainer = Color(0xFF365650),
    onSecondaryContainer = Color.White,
    tertiary = Color(0xFFFFD77C),
    onTertiary = Color.Black,
    tertiaryContainer = Color(0xFF745300),
    ...
    error = Color(0xFFFFB4AB),
    onError = Color.Black,
    errorContainer = Color(0xFF7F0008),
...
private fun baseTypography(): Typography {
    ...
    return material.copy(
        headlineLarge = material.headlineLarge.copy(
            fontSize = 32.sp,
            lineHeight = 40.sp,
            fontWeight = FontWeight.Bold
        ),
        headlineMedium = material.headlineMedium.copy(
            fontSize = 27.sp,
            lineHeight = 35.sp,
            fontWeight = FontWeight.Bold
        ),
        headlineSmall = material.headlineSmall.copy(
            fontSize = 23.sp,
            lineHeight = 31.sp,
            fontWeight = FontWeight.SemiBold
        ),
        titleLarge = material.titleLarge.copy(
            fontSize = 21.sp,
            lineHeight = 29.sp,
            fontWeight = FontWeight.Bold
        ),
        titleMedium = material.titleMedium.copy(
            fontSize = 17.sp,
            lineHeight = 25.sp,
            fontWeight = FontWeight.SemiBold
        ),
        titleSmall = material.titleSmall.copy(
            fontSize = 15.sp,
            lineHeight = 23.sp,
            fontWeight = FontWeight.SemiBold
        ),
        bodyLarge = material.bodyLarge.copy(
            fontSize = 17.sp,
            lineHeight = 28.sp,
            fontWeight = FontWeight.Normal
        ),
        bodyMedium = material.bodyMedium.copy(
            fontSize = 15.sp,
            lineHeight = 24.sp,
            fontWeight = FontWeight.Normal
        ),
        bodySmall = material.bodySmall.copy(
            fontSize = 13.sp,
            lineHeight = 20.sp,
            fontWeight = FontWeight.Normal
        ),
        labelLarge = material.labelLarge.copy(
            fontSize = 15.sp,
            lineHeight = 22.sp,
            fontWeight = FontWeight.SemiBold
        ),
        labelMedium = material.labelMedium.copy(
            fontSize = 13.sp,
            lineHeight = 19.sp,
            fontWeight = FontWeight.Medium
        ),
        labelSmall = material.labelSmall.copy(
            fontSize = 11.sp,
            lineHeight = 17.sp,
            fontWeight = FontWeight.Medium
        )
