...
export const assessmentReferences: AssessmentReference[] = [
  { id: 'cosmin', title: 'COSMIN Manual v2.0 — صلاحية المحتوى وخصائص القياس', organization: 'COSMIN', url: 'https://www.cosmin.nl/wp-content/uploads/COSMIN-manual-V2_final.pdf', role: 'إطار حديث لمراجعة الملاءمة والشمول وسهولة الفهم، ثم خصائص القياس الأخرى؛ لا يثبت صلاحية أدوات روافد قبل دراستها مباشرة.' },
  { id: 'fda-pro', title: 'Selecting, Developing, or Modifying Fit-for-Purpose Clinical Outcome Assessments — Final Guidance', organization: 'U.S. Food and Drug Administration', url: 'https://www.fda.gov/media/159500/download', role: 'التوجيه النهائي الصادر في أكتوبر 2025 لتحديد المفهوم والسياق وتطوير أو تعديل أدوات قياس ملائمة للغرض؛ لا يثبت صلاحية أدوات روافد.' },
  { id: 'efpa', title: 'EFPA Test Review Model — Version 2025', organization: 'European Federation of Psychologists’ Associations', url: 'https://www.efpa.eu/sites/default/files/2025-08/efpa_test_review_model_v2025_5.pdf', role: 'إطار لمراجعة التوثيق والمعايير والثبات والصدق والإنصاف والاستخدام الرقمي قبل وصف أي أداة بأنها مقننة.' },
