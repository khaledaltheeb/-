...
export const assessmentOperationalFullFormsWave5: Record<string, AssessmentOperationalMaterial> = {
  'kdigo-acute-kidney-injury-stage': {
    ...
    provenance: 'تعتمد الورقة على معايير KDIGO 2012 النهائية. موقع KDIGO في سبتمبر 2026 ما يزال يعرض تحديث AKI/AKD 2026 كمسودة مراجعة عامة يجري إعدادها للنشر؛ لذلك لا تدمج روافد معايير المسودة مع المعيار النهائي الحالي.',
