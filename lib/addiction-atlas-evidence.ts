...
import riskEvidenceV9Json from '@/data/addiction-atlas/risk-evidence-v9.json';
...
const files = [riskEvidenceV4Json, riskEvidenceV5Json, riskEvidenceV6Json, riskEvidenceV7Json, riskEvidenceV8Json, riskEvidenceV9Json] as unknown as RiskEvidenceFile[];
