...
public final class MainActivity extends AppCompatActivity {
    private LinearLayout root; private SecurePrefs prefs;
    ...
    @Override protected void onCreate(@Nullable Bundle state){ super.onCreate(state); prefs=new SecurePrefs(this); requestNotifications(); showHome(); handleIntent(getIntent()); }
    ...
    private void showHome(){ shell("معرفة موثوقة، وأدوات تهتم بك كل يوم");
    ...
    private void showCompanion(){ shell("رفيقة روافد 💗");
    ...
    private void showCalendar(){ shell("تقويم المرأة 🌷");
    ...
    private TextView text(String s,int sp,boolean bold,int color){ TextView t=new TextView(this); t.setText(s); t.setTextSize(sp); t.setTextColor(color); t.setTextDirection(View.TEXT_DIRECTION_RTL); t.setGravity(Gravity.END); if(bold)t.setTypeface(t.getTypeface(),1); t.setLineSpacing(0,1.15f); t.setPadding(0,dp(5),0,dp(5)); return t; }
