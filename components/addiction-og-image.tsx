...
export function addictionOgImage(title: string) {
  ...
  return new ImageResponse((
    <div dir="rtl" style={{width:'100%',height:'100%',display:'flex',position:'relative',overflow:'hidden',background:'linear-gradient(135deg,#fffaf3 0%,#ffffff 50%,#eefaf8 100%)',color:'#183d40',fontFamily:'sans-serif'}}>
