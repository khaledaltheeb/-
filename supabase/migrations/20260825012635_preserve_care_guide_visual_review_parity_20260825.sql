-- Keep review provenance available to SEO/structured data while preserving the
-- pre-agent visual presentation for records normalized in the hidden-SEO pass.
