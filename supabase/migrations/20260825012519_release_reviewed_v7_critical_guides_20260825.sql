-- Normalize the two rewritten V7 critical Care Guides after the fresh Rawafid
-- team review checkpoint. This migration changes release/review metadata only;
-- it does not modify public body content, routes, canonicals or presentation.
