...
-- Ensure each released page is attached to its intended rehabilitation category.
...
-- Assert the eight durable guides are still published, indexable, correctly
-- classified, and backed by the central source registry.
do $$
declare
  v_pages integer;
  v_linked integer;
