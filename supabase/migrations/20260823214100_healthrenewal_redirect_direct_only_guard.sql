-- Keep every migration redirect one hop only during the healthrenewal.org cutover.
-- The production database already has this idempotent guard; this file preserves
-- the intended schema state in source control for future environments.
