-- Source-parity migration for the direct-redirect guard already active in production.
-- This file is intentionally idempotent. Do not use redirects that create A -> B -> C chains.
