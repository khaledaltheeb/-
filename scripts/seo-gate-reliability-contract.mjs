...
for (const token of ['response.status !== 200', "contentType.includes('text/html')", 'SHARED_CRAWL_USER_AGENT', 'gzipAsync']) {
...
if (!process.exitCode) console.log('SEO gate reliability contract passed: reduced crawl load without reduced coverage or blocking semantics.');
