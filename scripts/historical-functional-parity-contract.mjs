...
if(bad)process.exit(1);console.log('Historical functional parity contract passed: 3 assessments and 8 cognitive tasks restored in place with local-only interactions.');