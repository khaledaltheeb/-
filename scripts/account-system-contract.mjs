...
requireText('app/login/actions.ts',['signInWithPassword','safeNext','redirect(next)']);
...
requireText('app/account/security/page.tsx',['current_password','new_password','confirm_password','/forgot-password']);
...
if(!process.exitCode)console.log('Rawafid complete account/auth/provider-verification system contract passed.');
