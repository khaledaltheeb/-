...
if (!process.exitCode) {
  console.log(`ASSESSMENT_OPERATIONAL_CONTRACT_PASS: ${explicitSlugs.length} base forms/protocols + ${fullFormSlugs.length} Full Forms Wave 1 + universal fallback + A4 print architecture verified.`);
}
