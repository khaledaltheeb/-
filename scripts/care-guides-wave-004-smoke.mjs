...
for (const [route, titleMarker] of publishedIndexable) {
  await verifyPublishedRoute(route, titleMarker);
}

if (failed) process.exit(1);
console.log(`Wave 004 rendered smoke passed for ${publishedIndexable.length} current published/indexable pages.`);
