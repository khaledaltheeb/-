...
requireText(layout, 'strategy="lazyOnload"', 'direct GA4 must wait until the page load is idle');
...
console.log('PageSpeed performance contract passed: GA4 remains enabled, heavy GTM is gated, font LCP is non-blocking, and the assistant is lazy-loaded.');
