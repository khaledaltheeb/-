...
const orphanRights = rightsRestricted.filter((slug) => !allSet.has(slug));
...
if (!process.exitCode) {
  console.log('ASSESSMENT_OPERATIONAL_COVERAGE_PASS: no explicit-form/rights-restricted collision. The unresolved array is the deterministic next-work queue.');
}
