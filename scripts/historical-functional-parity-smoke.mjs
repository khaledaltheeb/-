...
for(const route of ['/assessments/gad-7/','/assessments/phq-9/','/assessments/who-5/'])await fetchInPlace(route,'مصدر رسمي');
for(const route of ['/cognitive-tests/digit-span/','/cognitive-tests/matrix-reasoning/','/cognitive-tests/n-back/','/cognitive-tests/number-series/','/cognitive-tests/reaction-time/','/cognitive-tests/spatial-rotation/','/cognitive-tests/stroop/','/cognitive-tests/verbal-analogies/'])await fetchInPlace(route,'نشاط تاريخي محفوظ');
