...
requireMatch('lib/quick-info.ts', files.quickInfo, /بطاقة معلومات سريعة من منصة روافد بعنوان/, 'descriptive image alt text missing.');
...
requireMatch('generator', files.generator, /select','slug,title,excerpt,canonical_url,schema_json'/, 'image generator must derive copy from page records.');
requireMatch('generator', files.generator, /limit','500'/, 'image generator must use one bounded Supabase read.');
forbid('generator', files.generator, />ر<\/text>/, 'temporary letter logo must not appear in generated images.');
forbid('generator', files.generator, /cx="206" cy="240"|<g opacity="\.9">/, 'generated images must not contain the retired decorative pictogram.');
