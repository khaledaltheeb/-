...
if (!process.exitCode) console.log('Assessment lab contract passed: 60 Rawafid monitoring tools + 10 source/rights pages = 70 published routes; custom-reviewed banks are loaded with no stored answers or fabricated scoring.');
