...
const encyclopediaConditionRedirects = ['autism','depression','alcohol-use-disorder','cannabis-use-disorder','gambling-related-harms','gaming-disorder','inhalant-use-disorder','nicotine-tobacco-dependence','opioid-use-disorder','polysubstance-use-and-overdose-risk','sedative-benzodiazepine-use-disorder','stimulant-use-disorder'].map((slug)=>({source:`/content/${slug}`,destination:`/encyclopedia/${slug}/`,permanent:true}));
const cognitiveLabLegacyRewrites=[{source:'/cognitive-lab/associative-context-binding',destination:'/cognitive-lab/associative-binding'},{source:'/cognitive-lab/prospective-memory-cues',destination:'/cognitive-lab/prospective-memory'}];
const legacyHubRewrites=[{source:'/hubs',destination:'/content/legacy-landing-hubs'},{source:'/hubs/',destination:'/content/legacy-landing-hubs'},{source:'/hubs/:slug',destination:'/content/legacy-hub-:slug'},{source:'/hubs/:slug/',destination:'/content/legacy-hub-:slug'}];
...
const nextConfig:NextConfig={
  ...
  async rewrites(){return [...cognitiveLabLegacyRewrites,...legacyHubRewrites,{source:'/resources/:slug',destination:'/content/:slug'},{source:'/resources/:slug/',destination:'/content/:slug'}]},
