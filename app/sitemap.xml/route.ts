...
export async function GET(){
 ...
 const paths=['/sitemaps/static.xml','/sitemaps/taxonomy.xml','/sitemaps/quick-info.xml','/sitemaps/encyclopedia.xml?page=0','/sitemaps/specialists.xml','/sitemaps/centers.xml','/sitemaps/community.xml',...Array.from({length:pages},(_,page)=>`/sitemaps/content.xml?page=${page}`)];
