...
export default async function QuickInfoDetailPage({ params }: { params: Params }) {
  ...
  const articleSchema = {
    ...
    datePublished: record.published_at || undefined, dateModified: record.updated_at || undefined, lastReviewed: record.last_reviewed_at || undefined,
