...
function route(slug:string[]=[]){return `/${['library',...slug].join('/')}/`;}
...
export default async function LibraryLanding({params}:{params:Params}){const {slug}=await params;return <LegacyPreservedRoute route={route(slug)}/>;}
