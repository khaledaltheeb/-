...
const groups: AdminNavGroup[] = [
 ...
 {label:'الدليل والمجتمع',items:[['/admin/verification','مركز التحقق'],['/admin/specialists','المختصون والتوثيق'],['/admin/centers','المراكز والفروع'],['/admin/community','المتدربون والمتطوعون'],['/admin/users','المستخدمون والصلاحيات']]},
