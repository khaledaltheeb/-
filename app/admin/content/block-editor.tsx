...
const labels: Record<BlockType, string> = {
  paragraph: 'فقرة', heading: 'عنوان فرعي', list: 'قائمة', quote: 'اقتباس', callout: 'تنبيه/معلومة', table: 'جدول', resource: 'مصدر خارجي', image: 'صورة داخل المحتوى', faq: 'أسئلة شائعة', divider: 'فاصل',
};
