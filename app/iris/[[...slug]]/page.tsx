...
function route(slug:string[]=[]){return `/${['iris',...slug].join('/')}/`;}
...
export default async function IrisLanding({params}:{params:Params}){const {slug}=await params;return <LegacyPreservedRoute route={route(slug)}/>;}
