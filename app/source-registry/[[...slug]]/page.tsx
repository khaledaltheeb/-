...
function route(slug:string[]=[]){return `/${['source-registry',...slug].join('/')}/`;}
...
export default async function SourceRegistryLanding({params}:{params:Params}){const {slug}=await params;return <LegacyPreservedRoute route={route(slug)}/>;}
