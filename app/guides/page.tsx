...
export const metadata: Metadata = buildSeoMetadata({ title:'الأدلة المنقولة والمطورة', description:'الأدلة التاريخية في روافد بعد نقل محتواها إلى التطبيق الجديد بدل تحويل الروابط، مع مصادر رسمية ومسارات أعمق داخل المنصة.', path:'/guides', index:false, follow:true });
