...
const ROOT_METADATA = buildSeoMetadata({
  ...
  description: 'مكتبة عربية علمية لمقدمي الخدمة تربط 100 حالة بالتقييم متعدد المصادر وخط الأساس والتجارب القابلة للعكس وجودة التنفيذ والقياس وقواعد التوقف وإعادة القرار.',
