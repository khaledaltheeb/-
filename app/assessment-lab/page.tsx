...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description: 'قطاع اختبر نفسك في روافد: 48 أداة متابعة ذاتية عربية غير تشخيصية و10 صفحات موثقة لمقاييس خارجية وحقوق استخدامها؛ 58 مسارًا منشورًا بلا حفظ بيانات أو نسخ غير مصرح به.',
  path: '/assessment-lab',
  index: true,
  follow: true,
  keywords: ['اختبر نفسك', 'اختبارات نفسية', 'فحص ذاتي', 'متابعة ذاتية', 'الصحة النفسية', 'النوم', 'القلق', 'الضغط النفسي', 'الاحتراق النفسي', 'التسويف', 'الكمالية', 'الحمل الرقمي', 'وسائل التواصل', 'PHQ-9', 'GAD-7', 'WHO-5', 'AUDIT', 'PSQI', 'MBI', 'PROMIS', 'K10', 'PSS', 'Zarit'],
});
...
export default function AssessmentLabPage() {
  ...
  return <><SiteHeader/><main className={styles.page}>
    ...
    <section className={styles.hero}><div className={styles.shell}>
      ...
      <div className={styles.facts}><span><strong>48</strong> أداة متابعة محلية</span><span><strong>10</strong> صفحات أدوات مصدرية وحقوق</span><span><strong>58</strong> مسارًا منشورًا</span><span><strong>0</strong> إجابات محفوظة</span></div>
    </div></section>
