...
export const metadata: Metadata = buildSeoMetadata({
  ...
  description: 'قطاع اختبر نفسك في روافد: 60 أداة متابعة ذاتية عربية غير تشخيصية و10 صفحات موثقة لمقاييس خارجية وحقوق استخدامها؛ 70 مسارًا منشورًا بلا حفظ بيانات أو نسخ غير مصرح به.',
  path: '/assessment-lab',
  index: true,
  follow: true,
  keywords: ['اختبر نفسك', 'اختبارات نفسية', 'فحص ذاتي', 'متابعة ذاتية', 'الصحة النفسية', 'النوم', 'القلق', 'الضغط النفسي', 'الاحتراق النفسي', 'التسويف', 'الكمالية', 'الغضب', 'الاجترار', 'القلق الصحي', 'القلق الاجتماعي', 'قلق الأداء', 'حل المشكلات', 'طلب المساعدة', 'الحدود', 'الحمل الرقمي', 'وسائل التواصل', 'PHQ-9', 'GAD-7', 'WHO-5', 'AUDIT', 'PSQI', 'MBI', 'PROMIS', 'K10', 'PSS', 'Zarit'],
});
