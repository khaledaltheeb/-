...
const evidence = [
  {
    ...
    href: 'https://publications.aap.org/pediatrics/article/154/6/e2024069090/199876/Literacy-Promotion-An-Essential-Component-of',
  },
  {
    ...
    href: 'https://pubmed.ncbi.nlm.nih.gov/29415825/',
  },
  {
    title: 'الرعاية المستجيبة والتعلم المبكر',
    text: 'يركز إطار الرعاية الحانية من منظمة الصحة العالمية على ملاحظة إشارات الطفل وفهمها والاستجابة لها، وإتاحة فرص تعلم مبكر ممتعة داخل العلاقة اليومية.',
    href: 'https://www.who.int/publications/i/item/9789240058651',
  },
];
