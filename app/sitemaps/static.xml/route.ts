...
export async function GET() {
  return sitemapResponse([
    ...
    { path:'/institutions', changeFrequency:'monthly', priority:.7 },
    { path:'/en/institutions', changeFrequency:'monthly', priority:.66 },
    { path:'/institutions/arabic-rtl-assurance', changeFrequency:'monthly', priority:.66 },
    { path:'/institutions/terminology-qa', changeFrequency:'monthly', priority:.64 },
    { path:'/institutions/open-source', changeFrequency:'monthly', priority:.64 },
