...
export async function GET() {
  return sitemapResponse([
    ...
    { path:'/cochrane/', changeFrequency:'weekly', priority:.82 },
    { path:'/cochrane/resources/', changeFrequency:'monthly', priority:.76 },
    { path:'/cochrane/read-review/', changeFrequency:'monthly', priority:.74 },
    { path:'/cochrane/certainty/', changeFrequency:'monthly', priority:.74 },
    { path:'/cochrane/ms/', changeFrequency:'monthly', priority:.78 },
    { path:'/cochrane/arabic-pilot/', changeFrequency:'weekly', priority:.7 },
