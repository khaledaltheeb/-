...
function route(slug:string[]=[]){return `/${['tips',...slug].join('/')}/`;}
...
export default async function TipsLanding({params}:{params:Params}){const {slug}=await params;return <LegacyPreservedRoute route={route(slug)}/>;}
