      ...
      <main className="site-shell rawafid-home">
        ...
        <section className="rawafid-section rawafid-pathways" aria-labelledby="pathways-title">
          ...
          <div className="rawafid-platform-grid">
            ...
            <Link prefetch={false} classNameName="rawafid-platform-card" href="/evidence-guides/"><div className="icon-shell"><PlatformIcon name="review" /></div><h3>الأدلة العلمية</h3><p>صفحات تلخص الأدلة والدراسات والمصادر مع سياق منهجي واضح.</p><span>استكشف الأدلة العلمية ←</span></Link>
