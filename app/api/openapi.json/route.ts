...
export async function GET(request: Request) {
  ...
  const document = {
    ...
    info: {
      ...
      description: 'واجهة عامة للمواد المنشورة فقط، مع سجل مصادر مترابط واكتشاف أدلة عبر Europe PMC وCrossref وLens، وفصل منظم لحقوق metadata/content وprovenance للترجمة. مفاتيح الشركاء اختيارية وتضيف تعريفًا مؤسسيًا وحصص استخدام؛ ولا تمنح الواجهة تلقائيًا حق إعادة نشر النصوص أو المصادر الخارجية.',
