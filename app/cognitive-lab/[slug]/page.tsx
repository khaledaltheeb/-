      ...
      <main className="cognitive-lab-page cognitive-tool-page">
        ...
        <section className="cognitive-shell cognitive-reading" aria-labelledby="cognitive-reading-title">
          <div className="cognitive-reading__main">
            ...
            <p><Link href="/cognitive-lab/#cognitive-evidence-title">اقرأ الأساس العلمي وحدود الاستدلال للمختبر</Link> لفهم الفرق بين صحة المهمة برمجيًا والصدق السيكومتري، وأثر إعادة الاختبار، وحدود انتقال التدريب، ومتطلبات التقنين قبل استخدام أي نشاط كاختبار معياري.</p>
          ...
          <aside className="cognitive-reading__aside">
            ...
            <ul>
              ...
              <li><Link href="/cognitive-lab/#cognitive-evidence-title">راجع منهج الأدلة والتقنين</Link></li>
            </ul>
          </aside>
        </section>
