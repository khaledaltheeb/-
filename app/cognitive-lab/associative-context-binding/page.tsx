...
export const metadata:Metadata=buildSeoMetadata({title:tool?.title??'الربط الترابطي',description:tool?.summary??'نشاط تعليمي غير تشخيصي في مختبر القدرات.',path:`/cognitive-lab/${canonicalSlug}`,index:true,follow:true,type:'article',keywords:[tool?.title??'الربط الترابطي','مختبر القدرات','تدريب معرفي']});
