...
export const metadata:Metadata=buildSeoMetadata({title:tool?.title??'الذاكرة المستقبلية',description:tool?.summary??'نشاط تعليمي غير تشخيصي في مختبر القدرات.',path:`/cognitive-lab/${canonicalSlug}`,index:true,follow:true,type:'article',keywords:[tool?.title??'الذاكرة المستقبلية','مختبر القدرات','تدريب معرفي']});
