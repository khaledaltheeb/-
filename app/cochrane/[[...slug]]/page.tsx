...
function route(slug:string[]=[]){return `/${['cochrane',...slug].join('/')}/`;}
...
export default async function CochraneLanding({params}:{params:Params}){const {slug}=await params;return <LegacyPreservedRoute route={route(slug)}/>;}
