...
const batches = [
  ...
  { id: 'statistics', title: 'مقاييس الأثر والتركيب الإحصائي', eyebrow: 'Effect measures · synthesis', updated_on: statistics.updated_on, guides: statistics.guides },
  { id: 'grade-decision', title: 'GRADE ومن الدليل إلى القرار', eyebrow: 'Certainty · decision use', updated_on: gradeDecision.updated_on, guides: gradeDecision.guides },
  { id: 'ms-governance', title: 'تطبيقات MS والترجمة العربية والحوكمة', eyebrow: 'Worked examples · Arabic governance', updated_on: msGovernance.updated_on, guides: msGovernance.guides },
];
  ...
  return <>
    ...
    <main className="site-shell sector-page-shell">
      ...
      <section className="public-index-hero">
        <span className="eyebrow">Gold-standard build · 50-guide pre-release corpus</span>
        ...
        <div className="public-stat-strip"><span>{guideCount} صفحة مكتوبة</span><span>5 طبقات مترابطة</span><span>لا فهرسة قبل Quality Gate النهائي</span></div>
      </section>
