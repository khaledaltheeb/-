...
import { FOUNDER_DISPLAY_NAME, FOUNDER_NAME_EN } from '@/lib/founder';

export const metadata = buildSeoMetadata({
  title: 'كيفية الاستشهاد بمنصة روافد',
  description: 'صيغة مقترحة للاستشهاد بمنصة روافد أو بصفحة محددة مع العنوان والرابط الدائم وتاريخ الاطلاع، إضافة إلى مثال BibTeX وبيانات المؤسس.',
  path: '/citation',
  index: true,
  follow: true,
});
