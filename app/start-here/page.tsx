...
const pathways = [
  ...
  { title: 'أفكر في استخدام أداة أو اختبار', body: 'اقرأ الغرض والفئة العمرية وطريقة التفسير قبل البدء. الأداة التعليمية أو التحريّة لا تتحول إلى تشخيص لمجرد أنها تعطي نتيجة، والتمرين المعرفي لا يصبح اختبارًا سريريًا معياريًا دون دليل تقنين وصلاحية مناسب.', links: [['الأسئلة الاسترشادية','/guided-assessment'],['مختبر القدرات','/cognitive-lab'],['منهجية المراجعة','/medical-review-policy']] },
